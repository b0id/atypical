      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 mb-6">
        ...
        <ul className="space-y-3">
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://psychiatryonline.org/doi/book/10.1176/appi.books.9780890424841" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
          ...
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://www.nice.org.uk/guidance/cg178" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                  NICE Guidelines
                </a>
              </p>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200 mb-6">
        ...
        <ul className="space-y-3">
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://pubmed.ncbi.nlm.nih.gov/23810019/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                  Leucht et al. (2013)
                </a>
              </p>
          ...
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://pubmed.ncbi.nlm.nih.gov/16172203/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                  CATIE Trial (2005)
                </a>
              </p>
          ...
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://pubmed.ncbi.nlm.nih.gov/31860457/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                  Pilinger et al. (2020)
                </a>
              </p>
      ...
      <div className="bg-white p-6 rounded-lg border border-gray-200">
        ...
        <ul className="space-y-3">
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://www.accessdata.fda.gov/scripts/cder/daf/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
          ...
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://www.drugguide.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
                  Davis's Drug Guide
                </a>
              </p>
              <p className="text-gray-600 text-sm">Comprehensive, up-to-date drug information for healthcare providers</p>
            </div>
          </li>
          <li className="flex items-start">
            <svg className="h-5 w-5 text-purple-500 mr-2 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://oxfordmedicaleducation.com/psychiatry" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
          ...
          <li className="flex items-start">
            ...
            <div>
              <p className="font-medium text-gray-800">
                <a href="https://www.cambridge.org/core/journals/cns-spectrums" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800">
